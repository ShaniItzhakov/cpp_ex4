...
TEST_CASE("Test Player discover_cure function") {
    ...
    geneSplicerPlayer.build(); // Build a research station in BuenosAires - needed for discover cure
    ...
    scientistPlayer.build(); // Build a research station in Milan - needed for discover cure
...
TEST_CASE("Test Player treat function") {
    ...
    medicPlayer.discover_cure(Color::Blue); // Discover cure using 5 blue cards
